...
export declare namespace chromepolicy_v1 {
    ...
    export class Resource$Customers$Policies$Groups {
        ...
        listGroupPriorityOrdering(params?: Params$Resource$Customers$Policies$Groups$Listgrouppriorityordering, options?: MethodOptions): GaxiosPromise<Schema$GoogleChromePolicyV1ListGroupPriorityOrderingResponse>;
        ...
        listGroupPriorityOrdering(params: Params$Resource$Customers$Policies$Groups$Listgrouppriorityordering, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromePolicyV1ListGroupPriorityOrderingResponse>, callback: BodyResponseCallback<Schema$GoogleChromePolicyV1ListGroupPriorityOrderingResponse>): void;
        listGroupPriorityOrdering(params: Params$Resource$Customers$Policies$Groups$Listgrouppriorityordering, callback: BodyResponseCallback<Schema$GoogleChromePolicyV1ListGroupPriorityOrderingResponse>): void;
        listGroupPriorityOrdering(callback: BodyResponseCallback<Schema$GoogleChromePolicyV1ListGroupPriorityOrderingResponse>): void;
        /**

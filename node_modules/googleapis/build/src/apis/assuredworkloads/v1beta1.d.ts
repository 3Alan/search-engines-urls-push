...
export declare namespace assuredworkloads_v1beta1 {
    ...
    export class Resource$Organizations$Locations$Workloads {
        ...
        get(params?: Params$Resource$Organizations$Locations$Workloads$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>;
        ...
        get(params: Params$Resource$Organizations$Locations$Workloads$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>): void;
        get(params: Params$Resource$Organizations$Locations$Workloads$Get, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>): void;
        /**
        ...
        list(params?: Params$Resource$Organizations$Locations$Workloads$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListWorkloadsResponse>;
        ...
        list(params: Params$Resource$Organizations$Locations$Workloads$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListWorkloadsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListWorkloadsResponse>): void;
        list(params: Params$Resource$Organizations$Locations$Workloads$List, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListWorkloadsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListWorkloadsResponse>): void;
        /**
        ...
        patch(params?: Params$Resource$Organizations$Locations$Workloads$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>;
        ...
        patch(params: Params$Resource$Organizations$Locations$Workloads$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>): void;
        patch(params: Params$Resource$Organizations$Locations$Workloads$Patch, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Workload>): void;
        /**
    ...
    export class Resource$Organizations$Locations$Workloads$Organizations$Locations$Workloads {
        ...
        analyzeWorkloadMove(params?: Params$Resource$Organizations$Locations$Workloads$Organizations$Locations$Workloads$Analyzeworkloadmove, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>;
        ...
        analyzeWorkloadMove(params: Params$Resource$Organizations$Locations$Workloads$Organizations$Locations$Workloads$Analyzeworkloadmove, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>): void;
        analyzeWorkloadMove(params: Params$Resource$Organizations$Locations$Workloads$Organizations$Locations$Workloads$Analyzeworkloadmove, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>): void;
        analyzeWorkloadMove(callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>): void;
    }
    ...
    export class Resource$Organizations$Locations$Workloads$Violations {
        ...
        get(params?: Params$Resource$Organizations$Locations$Workloads$Violations$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Violation>;
        ...
        get(params: Params$Resource$Organizations$Locations$Workloads$Violations$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Violation>, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Violation>): void;
        get(params: Params$Resource$Organizations$Locations$Workloads$Violations$Get, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Violation>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1Violation>): void;
        /**
        ...
        list(params?: Params$Resource$Organizations$Locations$Workloads$Violations$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListViolationsResponse>;
        ...
        list(params: Params$Resource$Organizations$Locations$Workloads$Violations$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListViolationsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListViolationsResponse>): void;
        list(params: Params$Resource$Organizations$Locations$Workloads$Violations$List, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListViolationsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1ListViolationsResponse>): void;
    }
    ...
    export class Resource$Projects$Organizations$Locations$Workloads {
        ...
        analyzeWorkloadMove(params?: Params$Resource$Projects$Organizations$Locations$Workloads$Analyzeworkloadmove, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>;
        ...
        analyzeWorkloadMove(params: Params$Resource$Projects$Organizations$Locations$Workloads$Analyzeworkloadmove, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>): void;
        analyzeWorkloadMove(params: Params$Resource$Projects$Organizations$Locations$Workloads$Analyzeworkloadmove, callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>): void;
        analyzeWorkloadMove(callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsVersioningV1beta1AnalyzeWorkloadMoveResponse>): void;
    }

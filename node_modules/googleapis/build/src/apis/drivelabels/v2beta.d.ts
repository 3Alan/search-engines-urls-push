...
export declare namespace drivelabels_v2beta {
    ...
    export class Resource$Labels$Permissions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Labels$Permissions$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Labels$Permissions$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>;
        patch(params: Params$Resource$Labels$Permissions$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Labels$Permissions$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>, callback: BodyResponseCallback<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>): void;
        patch(params: Params$Resource$Labels$Permissions$Patch, callback: BodyResponseCallback<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>): void;
    }
    ...
    export interface Params$Resource$Labels$Permissions$Patch extends StandardParameters {
        /**
         * Required. The parent Label resource name.
         */
        parent?: string;
    ...
    export class Resource$Labels$Revisions$Permissions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Labels$Revisions$Permissions$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Labels$Revisions$Permissions$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>;
        patch(params: Params$Resource$Labels$Revisions$Permissions$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Labels$Revisions$Permissions$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>, callback: BodyResponseCallback<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>): void;
        patch(params: Params$Resource$Labels$Revisions$Permissions$Patch, callback: BodyResponseCallback<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleAppsDriveLabelsV2betaLabelPermission>): void;
    }
    ...
    export interface Params$Resource$Labels$Revisions$Permissions$Patch extends StandardParameters {
        /**
         * Required. The parent Label resource name.
         */
        parent?: string;
